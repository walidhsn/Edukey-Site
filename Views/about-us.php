    ...
    <div class="page-content grid-row">
			<main>
				<section class="clear-fix">
					<h2>EduKey</h2>
					<p class="fs-18"><strong>EduKey is a massive open online course provider:</strong></p>
					<img src="pic/aboutus.png" data-at2x="pic/aboutus.png" class="border-img img-float-left" alt>
					<p><b> it s a learning experience arranges coursework into a series of modules and lessons that can include videos, text notes and assessment tests.</b>
                    <b>Dozens of EduKey courses are free, though they can cost up to 159.99.DT and higher. Courses on the site are discounted frequently.</b>
                    <b>EduKey doesn’t offer accredited degrees or certifications, but it can provide professional development.</b>
                    <b>If you want to learn new skills but aren’t necessarily looking for a degree or courses affiliated with a college or university,</b><br/><br/><b>EduKey might be a good fit for you. EduKey does issue certificates, but these are not accredited or university-aligned.</b>
                    <b>This doesn’t mean, however, that knowledge gained through EduKey can’t advance learning and careers.
                    <b>If you’re seeking to learn a specific skill, EduKey courses can provide step-by-step instructions to accomplish a goal. Coursera, on the other hand, has more of an academic focus on its subjects and courses.<b><b>EduKey is likely cheaper if you’re surveying specific subjects or working at a slower pace.</b>
                    <b>EduKey course purchasers get lifetime access to scholastic material, and many tutorials on Udemy tend to focus on more practical,hands-on applications.</b></p>

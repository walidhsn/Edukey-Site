        ...
        <!-- row -->
          <div class="tm-block-col tm-col-account-settings">
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              <h2 class="tm-block-title">ADD PDF</h2>
              <form enctype="multipart/form-data" action="upload_pdf_todb.php" class="tm-signup-form row" method="POST">
              <input type="hidden" name="id_Cour" value="<?=$id_cour?>">

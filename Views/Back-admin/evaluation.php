...
$listeEvaluation = $evaluationC->afficherEvaluation();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="row tm-content-row">
        <div class="col-sm-15 col-md-12 col-lg-10 col-xl-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
              ...
              <table class="table table-hover tm-table-big tm-product-table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Id</th>
                    <th scope="col">Question (Si null c'est une reponse)</th>
                    <th scope="col">id du formation</th>
                ...
                <tbody>
                    <?php foreach($listeEvaluation as $evaluation) { ?>
                  <tr>
                    <a hidden><?php echo $evaluation['id']; ?></a>
                    <td class="tm-product-name"><?php echo $evaluation['id']; ?></td>
                    <td><?php echo $evaluation['base_qs']; ?></td>
                    <td><?php echo $evaluation['nb_qs']; ?></td>
                    <td><?php echo $evaluation['cate']; ?></td>
                    <td>
                      <a href="deleteEvaluation.php?id=<?php echo $evaluation['id']; ?>" class="tm-product-delete-link">
                        <i class="far fa-trash-alt tm-product-delete-icon"></i>
                      </a>
                    </td>
                    <td>
                      <a href="modigyEvaluation.php?id=<?php echo $evaluation['id']; ?>" class="tm-product-delete-link">
            ...
            <!-- table container -->
            <a
              href="addevaluation.php"
              class="btn btn-primary btn-block text-uppercase mb-3">Ajouter une evaluation</a>
          </div>
        </div>
      </div>
    </div>

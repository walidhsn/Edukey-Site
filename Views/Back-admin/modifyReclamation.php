...
$id = $_GET["id"];
$reclamation = $reclamationC->recupererReclamation($id);

$titre = $reclamation['titre'];
$contenue = $reclamation['contenue'];
$nom_immuteur = $reclamation['nom_immuteur'];
$nom_recepteur = $reclamation['nom_recepteur'];
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Modifier reclamation</h2>
              </div>
            </div>

...
$liste_c = $categorie->afficher_categorie();
    ...
    if(isset($_POST['submitAjoute']))
    {
        ...
        if(isset($_POST['name']) && isset($_POST['categorie']) && isset($_POST['number']) && isset($_POST['time']) && isset($_POST['price']) && isset($_POST['rate']) && isset($_POST['description']))
        {
            ...
            {
                $userC = new UserC();
                $user = $userC->chercher_user($_SESSION['id']);
                $date_creation = date("Y-m-d");
                $editor = $user['nom']." ".$user['prenom'];
                $formation_ajouter = new Formation($_POST['name'],$_POST['categorie'],$_POST['number'],$_POST['time'],$_POST['price'],$_POST['rate'],$date_creation,$_POST['description'],$editor);

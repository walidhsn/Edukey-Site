				...
				<div class="grid-col grid-col-9">
					...
					<main>
                        ...
                        if(isset($_GET['id_formation']))
                        {
                            ...
                            $img=$formationC->display_img($id);
                        } 
                        ?>
						<section>
							<h2>Courses of <?=$row['nom']?></h2>
							<div class="picture">
							...
							<div class="tabs">
								<div class="block-tabs-btn clear-fix">
									...
									<div class="tabs-btn" data-tabs-id="tabs2">Creator</div>
									<div class="tabs-btn" data-tabs-id="tabs3">Apply</div>
								</div>
								<!-- tabs keeper -->
								<div class="tabs-keeper">
									...
									<div class="container-tabs active" data-tabs-id="cont-tabs1">
										<h3><?=$row['categorie']?></h3>
										<p><?=$row['description']?> </br> Number of documents : <?=$row['nb_cour']?> </br> Time to Study it : <?=$row['temp']?> </br> Rate : <?=$row['taux']?>/5</p>
									</div>
									<!--/tabs container -->
									<!-- tabs container -->
									<div class="container-tabs" data-tabs-id="cont-tabs2">
										<h3>BY : <?=$row['editor']?></h3>
										<p>Teacher of <?=$row['categorie']?></p>
									</div>
									<!--/tabs container -->
									<!-- tabs container -->
									<div class="container-tabs" data-tabs-id="cont-tabs3">
										<h3>BUY Now</h3>
										<p><?=$row['prix']?>.Dt</p>
                                        <form action="afficher_cour.php" metode="post">
                                            <input type="hidden" name="id_formation" value="<?=$row['id_formation']?>">
                                            <input type="hidden" name="nom_categorie" value="<?=$row['categorie']?>">
                                        <button class="cws-button bt-color-4 border-radius alt large" name="buy">Enroll</button>
                                        </form>
									</div>
									<!--/tabs container -->
								</div>
									...
									<div class="comment_container clear">
										...
										<div class="comment-text">
											...
											<p class="meta">
												...
												<time datetime="2016-06-07T12:14:53+00:00">/ 2021.12.2 12:12:14</time>
											</p>
